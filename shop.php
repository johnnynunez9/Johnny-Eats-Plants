...
<head lang="en">
    ...
    <!--Page Title-->
    <title>Johnny Eats Plants | Vegan Activism</title>
        ...
        <header id="banner" class="scrollto clearfix" data-enllax-ratio=".5">
                    ...
                    <div class="col-1">
                        ...
                        <aside>
                            ...
                            <ul class="social-icons">
                                <li>
                                    <a target="_blank" title="Facebook" href="https://www.facebook.com/johnnyeatsplants">
                                        <i class="fa fa-facebook fa-1x"></i><span>Facebook</span>
                                    </a>
                                </li>
                                </li>
                                <li>
                                    <a target="_blank" title="Instagram" href="https://www.instagram.com/johnnyeatsplants/">
            ...
            <div id="banner-content" class="row clearfix">
                ...
                <div class="col-38">
                    ...
                    <div>
                        <h1>Utah Vegan Community</h1>
                        <h2>Animal rights activism and non-profit volunteering opportunities.</h2>
                    </div>

                    <!--Call to Action-->
                    <a href="https://goo.gl/forms/RbDuCLlrkTsULBYx1" target="_blank" class="button">GET INVOLVED</a>
                    <!--End Call to Action-->
                    ...
                    <div class="col-2-3">
                        ...
                        <div class="col-2 icon-block icon-top wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div class="icon-block-description">
                                ...
                                <p>Id porro tritani recusabo usu, eum intellegam consequuntur et. Fugit debet ea sit,
                                    an pro
                                    nemore vivendum</p>
                            </div>
                        </div>
